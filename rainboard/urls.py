...
urlpatterns = [
    ...
    path(
        ...
        views.ProjectGitlabView.as_view(),
        name="project-gitlab",
    ),
    ...
    path(
        "graph",
        TemplateView.as_view(template_name="rainboard/graph.html"),
        name="graph",
    ),
